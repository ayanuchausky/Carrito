...
import examen.repository.ClienteRepository;
...
/**
 * REST controller for managing {@link examen.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ClienteResource {
    ...
    public ClienteResource(UserService userService, ClienteRepository clienteRepository) {
